...
export default function BoxMascota({ mascota, redirigirPerfil = false }: Props) {
      ...
      >
        <VStack align="start" gap="2">
          <HStack flexWrap="wrap" align="center" gap="2">
            {mascota.especie && (
              <Text fontSize="sm">{iconoEspecie[mascota.especie] ?? iconoEspecie['OTRO']}</Text>
            )}
            ...
            {mascota.esterilizado && (
              ...
              >
                <HStack gap="1">
                  {mascota.esterilizado === 'ESTERILIZADO' && <EggOff size={16} color="white" />}
                  {mascota.esterilizado === 'NO_ESTERILIZADO' && <Egg size={16} color="white" />}
                  {mascota.esterilizado === 'DESCONOCIDO' && <CircleHelp size={16} color="white" />}
                </HStack>
              </Box>
            )}
          </HStack>
          ...
          {mascota.nombrePerfil && mascota.perfilId && (
            <Box
              ...
              px="2"
              py="1"
              _hover={redirigirPerfil ? { bg: 'tema.llamativo', cursor: 'pointer' } : undefined}
